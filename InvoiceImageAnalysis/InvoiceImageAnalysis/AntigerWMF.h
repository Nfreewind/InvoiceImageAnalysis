...
/***************************************************************/
/*
*   Fast Weighted Median Filter, Q.Zhang, L. Xu, J. Jia, CVPR2014
/***************************************************************/
...
public:
	...
	static Mat filter(Mat &I, Mat &feature, int r, float sigma=25.5, int nI=256, int nF=256, int iter=5, string weightType="iv1", Mat mask=Mat()){
